...
\begin{description}
	...
	\item[Asset Management:] Das Anlagevermögen eines Unternehmens setzt sich aus Assets zusammen, die einen finanziellen Wert haben und genutzt werden können, um Produkte oder Services zu erstellen. Meistens sind dieser Prozesse (Labeln der Assets usw.) bereits etabliert.
\end{description}
