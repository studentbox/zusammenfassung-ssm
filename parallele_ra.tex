...
Das Omega Netzwerk eignet sich im Gegensatz zu dem Crossbar Switch für den Einsatz in wirklich grossen Anlagen, da deutlich weniger Schalter verbaut werden müssen. Die Schalter sind in mehreren vertikalen Schichten angeordnet. In einem solchen Netz mit n Prozessoren gibt es $\log_2(n)$ Schichten mit genau $\frac{n}{2}$ Schaltern. Daraus folgt, dass die Gesamtanzahl der Schalter  $\log_2(n) \cdot \frac{n}{2}$ beträgt. Bei 8 Prozessoren werden also nicht 64 Leitungen wie beim Crossbar Switch benoetigt, sondern nur 12.
